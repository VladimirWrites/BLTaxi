object Versions {
    ...
    const val android_x_core_ktx = "1.3.1"
    ...
    const val android_x_databinding_compiler = "4.0.1"

    const val android_x_navigation = "2.3.0"
    ...
    const val firebase_performance = "19.0.8"

    const val koin = "2.1.6"

    const val retrofit = "2.9.0"
    const val ok_http_interceptor = "4.8.1"
    ...
    const val crashlytics_gradle_plugin = "2.2.1"
